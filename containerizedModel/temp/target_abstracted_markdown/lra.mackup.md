...
If you have @abstr_hyperlink installed and want to use it to save your config files, that's super easy.

On OS X, if you want an easy install, you can install @abstr_hyperlink and do:

@abstr_code_section 

If not running OS X, or you don't like Homebrew, you can use @abstr_hyperlink .
...
@abstr_number . `cp ~/.gitconfig ~/Dropbox/Mackup/.gitconfig` @abstr_number . `rm ~/.gitconfig` @abstr_number . `ln -s ~/Dropbox/Mackup/.gitconfig ~/.gitconfig`
...
@abstr_number . `ln -s ~/Dropbox/Mackup/.gitconfig ~/.gitconfig`
...
## Supported Storages
  ...
  * @abstr_hyperlink 
  * @abstr_hyperlink 
  * Anything able to sync a folder (e.g. @abstr_hyperlink )
...
## Supported Applications
  ...
  * @abstr_hyperlink 
  * @abstr_hyperlink 
  * @abstr_hyperlink (NOTE: includes private keys)
  * @abstr_hyperlink 
  * @abstr_hyperlink 
  * @abstr_hyperlink 
  * @abstr_hyperlink 
...
Yesterday, I had a talk with @abstr_hyperlink , complaining about the pain it is to reconfigure our Macbook each time we get a new one or install from scratch. That's a talk we have already had months ago.
...
Some people tried to solve the problem on the application layer, like @abstr_hyperlink , but it solves a different problem, from my point of view. I don't spend a lot of time installing or downloading stuff. I spend time configuring it.
...
And it's @abstr_hyperlink , of course.
