...
We're going to make a file that will print @abstr_hyperlink to your terminal.

## Objectives

@abstr_number . Create a new Ruby file. @abstr_number . Write syntactically valid code to produce "Hello World!" @abstr_number . Run a Ruby file. @abstr_number . Run the Learn gem. @abstr_number . Submit a Learn lab.
...
File: `hello_world.rb` @abstr_code_section 
...
_ @abstr_hyperlink based on a @abstr_number Bell Laboratories internal memorandum by Brian Kernighan, Programming in C: A Tutorial, which contains the first known version._
