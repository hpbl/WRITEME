#  @abstr_hyperlink - Object-based canvas drawing
...
The script uses @abstr_hyperlink , so you need to install that first. The minification is done by @abstr_hyperlink which is included in the repo.
...
All the documentation can be found at the website, @abstr_hyperlink 
