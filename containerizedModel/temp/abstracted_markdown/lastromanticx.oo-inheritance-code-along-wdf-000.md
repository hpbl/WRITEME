...
@abstr_number . Learn about inheritance in object oriented Ruby. @abstr_number . Write classes that inherit from another class. 
...
### Step @abstr_number : Defining the Super Class
...
### Step @abstr_number : Defining the Subclass
...
### Step @abstr_number : Overwriting Inherited Methods
